...
| **Settings → Companies → Email** | **the committee mailbox address** (e.g. `ocdesterrenboom@gmail.com`). Without it, mails sent by the public website have no sender at all. Setting it configures the outgoing mail identity below |
